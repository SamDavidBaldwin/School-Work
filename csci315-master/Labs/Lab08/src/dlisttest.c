...
int main(int argc, char *argv[]) {
  ...
  size_t sizeOfDnode = 10; 
  printf("\ntesting dlist_add_back\n");
  dlist_add_back(mylist, str1, sizeOfDnode );
  dlist_add_back(mylist, str2, sizeOfDnode );
  dlist_add_back(mylist, str3,sizeOfDnode );
  dlist_add_back(mylist, str4, sizeOfDnode );
  dlist_add_back(mylist, str5, sizeOfDnode );
  ...
  dlist_add_front(mylist, str1, sizeOfDnode );
  dlist_add_front(mylist, str2, sizeOfDnode );
  dlist_add_front(mylist, str3, sizeOfDnode );
  dlist_add_front(mylist, str4, sizeOfDnode );
  dlist_add_front(mylist, str5, sizeOfDnode );
